<p align="center">
  ...
  <br />
  <br />
  <a href="https://github.com/ralphbean/gh-dash-ng/releases"><img src="https://img.shields.io/github/release/ralphbean/gh-dash-ng.svg" alt="Latest Release"></a>
  <a href="https://www.jetify.com/docs/devbox" alt="Built with Devbox"><img src="https://www.jetify.com/img/devbox/shield_moon.svg" /></a>
</p>

> **Note:** This is a permanent fork of
> [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash), an awesome project
> created by [Dolev Hadar (@dlvhdr)](https://github.com/dlvhdr) and its
> [community of contributors](https://github.com/dlvhdr/gh-dash/graphs/contributors).
> All kudos are due to them for building a fantastic terminal UI for GitHub.
>
> This "next generation" (ng) edition was forked because the original project's
> [no-AI-usage policy](https://github.com/dlvhdr/gh-dash/blob/main/AI_POLICY.md)
> doesn't fit the fork maintainer's current development practices. The original
> project remains the canonical upstream — please check it out and consider
> [sponsoring its creator](https://github.com/sponsors/dlvhdr).
...
`DASH` was built by [@dlvhdr](https://github.com/dlvhdr). If you enjoy it,
consider supporting the original project at the
[sponsors page](https://github.com/sponsors/dlvhdr).

Thank you to all past and existing sponsors of the original project! 🙏🏽
...
**Original project:** Dolev Hadar ([@dlvhdr](https://github.com/dlvhdr)) and the [community](https://github.com/dlvhdr/gh-dash/graphs/contributors).

**Fork maintainer:** Ralph Bean ([@ralphbean](https://github.com/ralphbean)).
