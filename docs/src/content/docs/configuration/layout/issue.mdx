...
[`needsAttention`]: #issues-needs-attention-column
...
## Issues Needs Attention Column

| Property         | Type | Default                                            |
| :--------------- | :--- | :------------------------------------------------- |
| `needsAttention` | yaml | <Code code={`width: 4`} lang="yaml" frame="none"/> |

This column displays a 👀 icon when the most recent comment on an issue was
authored by someone other than the current user, indicating the issue may
need your attention.
